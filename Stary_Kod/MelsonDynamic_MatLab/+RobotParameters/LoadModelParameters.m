...
RobotModelParameters.r_CH_RA  = [0 -102 54.25]';
RobotModelParameters.r_RA_RFA = [0 0 -103]';
RobotModelParameters.r_RFA_RH  = [0 0 -90]';

RobotModelParameters.r_CH_LA  = [0 102 54.25]';
...
RobotModelParameters.r_RF_right_toe  = [63 -51.5 -35]';
RobotModelParameters.r_RF_left_toe   = [63 28.5 -35]';
RobotModelParameters.r_RF_right_heel = [-57 -51.5 -35]';
RobotModelParameters.r_RF_left_heel  = [-57 28.5 -35]';

RobotModelParameters.r_LF_center     = [0 0 -35]';
RobotModelParameters.r_LF_right_toe  = [63 -28.5 -35]';
RobotModelParameters.r_LF_left_toe   = [63 51.5 -35]';
RobotModelParameters.r_LF_right_heel = [-57 -28.5 -35]';
RobotModelParameters.r_LF_left_heel  = [-57 51.5 -35]';
