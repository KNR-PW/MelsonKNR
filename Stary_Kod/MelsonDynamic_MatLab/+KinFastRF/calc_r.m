...
rot_RF_W = Mat.RotX(-RFx) * Mat.RotY(-RFy-RSy-RTy) * Mat.RotX(-RTx) * Mat.RotZ(-RTz); 
...
r = [ rot_RF_W * (r_W_LF - r_W_RF);
          rot_RF_W * (r_W_RH - r_W_RF);
          rot_RF_W * (r_W_LH - r_W_RF);
          rot_RF_W * (r_W_CoM - r_W_RF)];



matlabFunction(r,'file','+KinFastRF\function_r.m','Vars',[RTz RTx RTy RSy RFy RFx LTz LTx LTy LSy LFy LFx RAy RAx RFAy LAy LAx LFAy CHz]);
