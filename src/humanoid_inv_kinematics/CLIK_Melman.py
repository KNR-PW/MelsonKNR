...
from src.humanoid_inv_kinematics.Jacobian_Melman_generator import Jacobian_Melman as J_M
...
q_max = np.array([15, 15, 0, 90, 90, 30, 15, 15, 0, 90, 90, 30, 90, 0, 0, 90, 90, 0]) * math.pi/180.0
q_min = np.array([-15, -15, -90, 0, -90, -30, -15, -15, -90, 0, -90, -30, -90, -90, -90, -90, 0, -90]) * math.pi/180.0
