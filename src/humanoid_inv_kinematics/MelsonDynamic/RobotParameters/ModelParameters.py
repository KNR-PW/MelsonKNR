...
# Skrypt przechowujacy wymiary humanoida w postaci wektorowej
...
r_com_W = np.array([[-15.048], [-0.004], [-92.396]])
r_com_CH = np.array([[-2.677], [0.036], [33.366]])
...
TotalMas = np.sum([mW, mCH, mRT, mLT, mRS, mLS, mRF, mLF, mRA, mLA, mRFA, mLFA])
...
JointU = np.concatenate(([-Uz, -Ux, -Uy, -Uy, -Uy, -Ux, Uz, Ux, Uy, Uy, Uy, Ux, Uy, Ux, Uy, Uy, Ux, Uy, Uz]), axis = 1)
