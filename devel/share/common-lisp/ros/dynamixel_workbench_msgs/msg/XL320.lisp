...
(cl:defmethod cl:initialize-instance :after ((m <XL320>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'XL320)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dynamixel_workbench_msgs-msg:<XL320> is deprecated: use dynamixel_workbench_msgs-msg:XL320 instead.")))

(cl:ensure-generic-function 'Model_Number-val :lambda-list '(m))
(cl:defmethod Model_Number-val ((m <XL320>))
...
(cl:defmethod Firmware_Version-val ((m <XL320>))
...
(cl:defmethod Baud_Rate-val ((m <XL320>))
...
(cl:defmethod Return_Delay_Time-val ((m <XL320>))
...
(cl:defmethod CW_Angle_Limit-val ((m <XL320>))
...
(cl:defmethod CCW_Angle_Limit-val ((m <XL320>))
...
(cl:defmethod Control_Mode-val ((m <XL320>))
...
(cl:defmethod Temperature_Limit-val ((m <XL320>))
...
(cl:defmethod Min_Voltage_Limit-val ((m <XL320>))
...
(cl:defmethod Max_Voltage_Limit-val ((m <XL320>))
...
(cl:defmethod Max_Torque-val ((m <XL320>))
...
(cl:defmethod Status_Return_Level-val ((m <XL320>))
...
(cl:defmethod Shutdown-val ((m <XL320>))
...
(cl:defmethod Torque_Enable-val ((m <XL320>))
...
(cl:defmethod D_gain-val ((m <XL320>))
...
(cl:defmethod I_gain-val ((m <XL320>))
...
(cl:defmethod P_gain-val ((m <XL320>))
...
(cl:defmethod Moving_Speed-val ((m <XL320>))
...
(cl:defmethod Torque_Limit-val ((m <XL320>))
...
(cl:defmethod Present_Speed-val ((m <XL320>))
...
(cl:defmethod Present_Load-val ((m <XL320>))
...
(cl:defmethod Present_Voltage-val ((m <XL320>))
...
(cl:defmethod Present_Temperature-val ((m <XL320>))
...
(cl:defmethod Registered-val ((m <XL320>))
...
(cl:defmethod Moving-val ((m <XL320>))
...
(cl:defmethod Hardware_Error_Status-val ((m <XL320>))
...
(cl:defmethod Punch-val ((m <XL320>))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<XL320>)))
  ...
  (cl:format cl:nil "# This message is compatible with control table of Dynamixel XL Series (XL320)~%# If you want to specific information about control table, please follow the link (http://emanual.robotis.com/)~%~%uint16 Model_Number~%uint8  Firmware_Version~%uint8  ID~%uint8  Baud_Rate~%uint8  Return_Delay_Time~%uint16 CW_Angle_Limit~%uint16 CCW_Angle_Limit~%uint8  Control_Mode~%uint8  Temperature_Limit~%uint8  Min_Voltage_Limit~%uint8  Max_Voltage_Limit~%uint16 Max_Torque~%uint8  Status_Return_Level~%uint8  Shutdown~%~%uint8  Torque_Enable~%uint8  LED~%uint8  D_gain~%uint8  I_gain~%uint8  P_gain~%uint16 Goal_Position~%uint16 Moving_Speed~%uint16 Torque_Limit~%uint16 Present_Position~%uint16 Present_Speed~%uint16 Present_Load~%uint8  Present_Voltage~%uint8  Present_Temperature~%uint8  Registered~%uint8  Moving~%uint8  Hardware_Error_Status~%uint16 Punch~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'XL320)))
  "Returns full string definition for message of type 'XL320"
  (cl:format cl:nil "# This message is compatible with control table of Dynamixel XL Series (XL320)~%# If you want to specific information about control table, please follow the link (http://emanual.robotis.com/)~%~%uint16 Model_Number~%uint8  Firmware_Version~%uint8  ID~%uint8  Baud_Rate~%uint8  Return_Delay_Time~%uint16 CW_Angle_Limit~%uint16 CCW_Angle_Limit~%uint8  Control_Mode~%uint8  Temperature_Limit~%uint8  Min_Voltage_Limit~%uint8  Max_Voltage_Limit~%uint16 Max_Torque~%uint8  Status_Return_Level~%uint8  Shutdown~%~%uint8  Torque_Enable~%uint8  LED~%uint8  D_gain~%uint8  I_gain~%uint8  P_gain~%uint16 Goal_Position~%uint16 Moving_Speed~%uint16 Torque_Limit~%uint16 Present_Position~%uint16 Present_Speed~%uint16 Present_Load~%uint8  Present_Voltage~%uint8  Present_Temperature~%uint8  Registered~%uint8  Moving~%uint8  Hardware_Error_Status~%uint16 Punch~%~%~%"))
