...
(cl:defclass <EX> (roslisp-msg-protocol:ros-message)
  ((Model_Number
   ...
   (Punch
    ...
    :initform 0)
   (Sensored_Current
    :reader Sensored_Current
    :initarg :Sensored_Current
    :type cl:fixnum
    :initform 0))
)
...
(cl:defmethod Firmware_Version-val ((m <EX>))
...
(cl:defmethod Temperature_Limit-val ((m <EX>))
...
(cl:defmethod Min_Voltage_Limit-val ((m <EX>))
...
(cl:defmethod Max_Voltage_Limit-val ((m <EX>))
...
(cl:defmethod Shutdown-val ((m <EX>))
...
(cl:defmethod Present_Speed-val ((m <EX>))
...
(cl:ensure-generic-function 'Sensored_Current-val :lambda-list '(m))
(cl:defmethod Sensored_Current-val ((m <EX>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dynamixel_workbench_msgs-msg:Sensored_Current-val is deprecated.  Use dynamixel_workbench_msgs-msg:Sensored_Current instead.")
  (Sensored_Current m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <EX>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'Sensored_Current)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 8) (cl:slot-value msg 'Sensored_Current)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EX>) istream)
  "Deserializes a message object of type '<EX>"
    ...
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'Sensored_Current)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 8) (cl:slot-value msg 'Sensored_Current)) (cl:read-byte istream))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<EX>)))
  ...
  "49929b8e4c95abff8543ee349bf2dc0b")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'EX)))
  "Returns md5sum for a message object of type 'EX"
  "49929b8e4c95abff8543ee349bf2dc0b")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<EX>)))
  "Returns full string definition for message of type '<EX>"
  (cl:format cl:nil "# This message is compatible with control table of Dynamixel EX Series (EX-106+)~%# If you want to specific information about control table, please follow the link (http://emanual.robotis.com/)~%~%uint16 Model_Number~%uint8  Firmware_Version~%uint8  ID~%uint8  Baud_Rate~%uint8  Return_Delay_Time~%uint16 CW_Angle_Limit~%uint16 CCW_Angle_Limit~%uint8  Drive_Mode~%uint8  Temperature_Limit~%uint8  Min_Voltage_Limit~%uint8  Max_Voltage_Limit~%uint16 Max_Torque~%uint8  Status_Return_Level~%uint8  Alarm_LED~%uint8  Shutdown~%~%uint8  Torque_Enable~%uint8  LED~%uint8  CW_Compliance_Margin~%uint8  CCW_Compliance_Margin~%uint8  CW_Compliance_Slope~%uint8  CCW_Compliance_Slope~%uint16 Goal_Position~%uint16 Moving_Speed~%uint16 Torque_Limit~%uint16 Present_Position~%uint16 Present_Speed~%uint16 Present_Load~%uint8  Present_Voltage~%uint8  Present_Temperature~%uint8  Registered~%uint8  Moving~%uint8  Lock~%uint16 Punch~%uint16 Sensored_Current~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'EX)))
  "Returns full string definition for message of type 'EX"
  (cl:format cl:nil "# This message is compatible with control table of Dynamixel EX Series (EX-106+)~%# If you want to specific information about control table, please follow the link (http://emanual.robotis.com/)~%~%uint16 Model_Number~%uint8  Firmware_Version~%uint8  ID~%uint8  Baud_Rate~%uint8  Return_Delay_Time~%uint16 CW_Angle_Limit~%uint16 CCW_Angle_Limit~%uint8  Drive_Mode~%uint8  Temperature_Limit~%uint8  Min_Voltage_Limit~%uint8  Max_Voltage_Limit~%uint16 Max_Torque~%uint8  Status_Return_Level~%uint8  Alarm_LED~%uint8  Shutdown~%~%uint8  Torque_Enable~%uint8  LED~%uint8  CW_Compliance_Margin~%uint8  CCW_Compliance_Margin~%uint8  CW_Compliance_Slope~%uint8  CCW_Compliance_Slope~%uint16 Goal_Position~%uint16 Moving_Speed~%uint16 Torque_Limit~%uint16 Present_Position~%uint16 Present_Speed~%uint16 Present_Load~%uint8  Present_Voltage~%uint8  Present_Temperature~%uint8  Registered~%uint8  Moving~%uint8  Lock~%uint16 Punch~%uint16 Sensored_Current~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <EX>))
  ...
  (cl:list 'EX
    ...
    (cl:cons ':Sensored_Current (Sensored_Current msg))
))
