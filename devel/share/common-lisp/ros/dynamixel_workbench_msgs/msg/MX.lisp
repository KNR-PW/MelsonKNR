...
(cl:defmethod Firmware_Version-val ((m <MX>))
...
(cl:defmethod Temperature_Limit-val ((m <MX>))
...
(cl:defmethod Min_Voltage_Limit-val ((m <MX>))
...
(cl:defmethod Max_Voltage_Limit-val ((m <MX>))
...
(cl:defmethod Shutdown-val ((m <MX>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MX>)))
  ...
  "f2b95d725db95aec0be4e30a981f545e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MX)))
  "Returns md5sum for a message object of type 'MX"
  "f2b95d725db95aec0be4e30a981f545e")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MX>)))
  "Returns full string definition for message of type '<MX>"
  (cl:format cl:nil "# This message is compatible with control table of Dynamixel MX Series (MX-12W, MX-28T/MX-28R/MX-28AT/MX-28AR)~%# If you want to specific information about control table, please follow the link (http://emanual.robotis.com/)~%~%uint16 Model_Number~%uint8  Firmware_Version~%uint8  ID~%uint8  Baud_Rate~%uint8  Return_Delay_Time~%uint16 CW_Angle_Limit~%uint16 CCW_Angle_Limit~%uint8  Temperature_Limit~%uint8  Min_Voltage_Limit~%uint8  Max_Voltage_Limit~%uint16 Max_Torque~%uint8  Status_Return_Level~%uint8  Alarm_LED~%uint8  Shutdown~%uint16 Multi_Turn_Offset~%uint8  Resolution_Divider~%~%uint8  Torque_Enable~%uint8  LED~%uint8  D_gain~%uint8  I_gain~%uint8  P_gain~%uint16 Goal_Position~%uint16 Moving_Speed~%uint16 Torque_Limit~%uint16 Present_Position~%uint16 Present_Speed~%uint16 Present_Load~%uint8  Present_Voltage~%uint8  Present_Temperature~%uint8  Registered~%uint8  Moving~%uint8  Lock~%uint16 Punch~%uint8  Goal_Acceleration~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MX)))
  "Returns full string definition for message of type 'MX"
  (cl:format cl:nil "# This message is compatible with control table of Dynamixel MX Series (MX-12W, MX-28T/MX-28R/MX-28AT/MX-28AR)~%# If you want to specific information about control table, please follow the link (http://emanual.robotis.com/)~%~%uint16 Model_Number~%uint8  Firmware_Version~%uint8  ID~%uint8  Baud_Rate~%uint8  Return_Delay_Time~%uint16 CW_Angle_Limit~%uint16 CCW_Angle_Limit~%uint8  Temperature_Limit~%uint8  Min_Voltage_Limit~%uint8  Max_Voltage_Limit~%uint16 Max_Torque~%uint8  Status_Return_Level~%uint8  Alarm_LED~%uint8  Shutdown~%uint16 Multi_Turn_Offset~%uint8  Resolution_Divider~%~%uint8  Torque_Enable~%uint8  LED~%uint8  D_gain~%uint8  I_gain~%uint8  P_gain~%uint16 Goal_Position~%uint16 Moving_Speed~%uint16 Torque_Limit~%uint16 Present_Position~%uint16 Present_Speed~%uint16 Present_Load~%uint8  Present_Voltage~%uint8  Present_Temperature~%uint8  Registered~%uint8  Moving~%uint8  Lock~%uint16 Punch~%uint8  Goal_Acceleration~%~%~%"))
